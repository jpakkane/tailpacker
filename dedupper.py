...
if __name__ == '__main__':
    if len(sys.argv) != 3:
        ...
        print('\nNote that this only works for x86 asm as generated by GCC/Clang.')
        print('\nNote also that using -g will break this because debug info gets interleaved in the code so it can not be dedupped easily.')
        sys.exit(1)
    ifile = sys.argv[1]
    ofile = sys.argv[2]
